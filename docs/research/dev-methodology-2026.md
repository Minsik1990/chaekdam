...
# 또는 수동 설정
npx create-next-app@latest dokdok --typescript --tailwind --eslint --app --src-dir
...
### 5.1 결론: DokDok은 Single App으로 시작
...
**DokDok 권장: Vercel Git Integration (기본) + GitHub Actions (테스트만)**
